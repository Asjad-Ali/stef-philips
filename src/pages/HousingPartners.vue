<template>
  ...
  <div class="w-full min-h-[500px] bg-red-400 bgImg">
    <div class="w-[60%] h-[500px] mx-auto flex items-center">
      ...
      >
        <h1
          class="font-light-custom text-[36px] leading-none text-white content"
        >
          <span>Working </span>
          <span class="font-black-custom text-[36px]">with you</span>
        </h1>
      ...
      <div class="lg:py-36 xxxs:py-20">
        <div class="lg:flex">
          <div class="lg:w-[50%] flex-auto">
            <img src="../assets/housing-partner-1.png" alt />
          </div>
          <div class="lg:w-[50%] pt-20 ml-6">
            ...
            >
              <span class="font-light-custom text-[36px]"
                >Our full-service</span
              >
              <span class="font-black-custom text-[36px]">
                end to end <br /> </span
              ><span class="font-light-custom text-[36px]"
                >offering overview</span
              >
            </h1>
            ...
            <button
              type="button"
              class="bg-[#2a8cfb] h-[50x] w-[205px] py-4 px-14 ml-8 text-[16px] mt-5 text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
            >
              Meet our team
            </button>
          </div>
        ...
        <div class="flex pt-20">
          <div class="lg:w-[50%] pt-40">
            ...
            >
              ...
              <span class="font-black-custom text-[36px]">easier</span>
            </h1>
            <p class="text-[18px] font-regular-custom mt-4 px-8">
              Sed efficitur risus eu imperdiet auctor. Mauris non Temporary
              accommodation odio PRS. Quisque mauris nisi, cursus id dictum id.
              Sed efficitur risus eu imperdiet auctor. Mauris non dapibus odio.
              Quisque mauris nisi, cursus id dictum id.
            </p>
            <button
              type="button"
              class="bg-[#2a8cfb] h-[50x] w-[290px] py-4 px-14 ml-8 text-[15px] mt-5 text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
            >
              Temporary accommodation</button
            ><br />
            <button
              type="button"
              class="bg-[#20407C] h-[50x] w-[290px] py-4 px-14 ml-8 text-[15px] mt-5 text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
            >
              Private rented sector
            </button>
          </div>
          <div class="lg:w-[50%] flex-auto">
            <img src="../assets/housing-partner-2.png" alt />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="mx-auto w-[70%] lg:py-10">
      <div class>
        <h1 class="py-4 text-white font-light-custom text-[36px]">
          The Stef & Philips difference <br /><span
            class="font-black-custom text-[36px]"
          >
            Our full-service solution</span
          >
        </h1>
        <p>
          End-to-end service that sets S&P apart - accountability, trust and
          control over the <br />entires process , making their life easier.
          Paragraph style fusce laoreet lorem id <br />consequat rhoncus.
        ...
        <div class="lg:flex">
          ...
          <div class="lg:w-[50%] pt-[11rem] ml-6">
            <h1
              class="px-8 text-[32px] lg:font-[400] xxxs:font-[200] text-trisec text-ellipsis leading-[40px]"
            >
              <span class="font-light-custom text-[36px]">Working with our</span
              ><br />
              <span class="font-black-custom text-[36px]"> partners</span>
            </h1>
            <p class="text-[18px] font-regular-custom mt-4 px-8">
              Short paragraph on the custom solutions to meet the needs of local
              authorities etc. and the turnkey properties that are ready to go
            </p>
            <br />
            <button
              type="button"
  ...
  <div class="lg:flex justify-center mx-auto max-w-[70%] my-16">
    <div
      class="bg-[#ededee] flex flex-col xl:w-[840px] justify-center px-8 py-4"
    >
      <h2 class="font-black-custom text-[24px] text-[#20407C]">
        Download brochure
      </h2>
  ...
  <div class="bgaccreditations h-[290px]">
    <div class="mx-auto w-[70%]">
      <div class="lg:flex">
        <div class="lg:w-[70%] pt-[4rem]">
          <h1
            class="px-8 text-[32px] text-[#20407C] lg:font-[400] xxxs:font-[200] text-ellipsis leading-[40px]"
          >
            <span class="font-light-custom [36px]">Our</span>
            <span class="font-black-custom [36px]"> accreditations</span>
          </h1>
        </div>
      </div>
      <div class="lg:flex pt-[3.5rem] pl-3">
        <div class="px-7">
          <img src="../assets/logo-ico.png" alt />
        </div>
        <div class="px-7">
          <img src="../assets/logo-prs.png" alt />
        </div>
        <div class="px-7">
          <img src="../assets/logo-london-.png" alt />
        </div>
        <div class="px-5">
          <img src="../assets/logo-newham-.png" alt />
        </div>
        <div class="px-5">
          <img src="../assets/logo-ombudsm.png" alt />
        </div>
        <div class="px-5">
          <img src="../assets/logo-tsi.png" alt />
        </div>
        <div class="px-5">
          <img src="../assets/logo-uk-ala.png" alt />
        </div>
      </div>
    </div>
  </div>
...
.bgImg {
  background-image: url("../assets/overlay-image-c.png");
  background-repeat: no-repeat;
