<template>
  <div
    class="lg:w-full min-h-[400px] bg-[url('src/assets/Background.png')] bg-center bg-no-repeat bg-cover"
  >
    <div
      class="max-w-[1440px] w-full p-3 flex flex-col justify-center items-center"
    >
      <div class="w-[60%] mx-auto">
        <h1 class="text-[42px] text-white font-[300] mt-16">Meet your team</h1>
...
const card1 = {
  ...
  btn: ["Read out more"],
  img: "src/assets/Card Image3.png",
  paragraph:
