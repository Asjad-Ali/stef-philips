          ...
          <div class=" w-full mx-auto grid">
            <div class="lg:flex font-regular-custom text-[18px] gap-5">
              <div class="mt-4 flex-auto px-8 text-white ">
                ...
                local authorities, housing associations, charitable
              ...
              <div class="mt-4 px-8 flex-auto text-white ">
                ...
                opportunity to get back on their feet. Our care reaches beyond
                bricks and mortar, to include specialised accommodation and
                services for mothers and babies, tenants with disabilities, and
   ...
   <div class=" mx-auto w-[70%]   lg:mr-1.5  pb-20 flex justify-center">
        <div class="w-full grid md:grid-cols-3 gap-8 grid-cols-1 sm:grid-cols-2 mt-10">
          ...
          <div class>
            ...
            <p
              class="text-white font-regular-custom text-[18px]"
            >Short description goes here<br>like so in this featured icon<br>element lore ipsum short<br>description goes here like</p>
          </div>
          <div class>
            <img  src="../assets/Svg/GreenHouseM.svg" alt />
            <h1 class="py-4 text-white font-black-custom text-[20px]">Value</h1>
