<template>
  <div class>
    ...
    <div class="bg-image-update py-[124px]">
      <div class="container">
        <h1 class="text-[36px] text-white leading-[40px] mb-[10px]">
          Our <span class="font-black-custom">seven step </span>investing process
        </h1>
        ...
        <div class="card generic-slider mt-[40px]">
          <Carousel :value="getsevenstepprocess" :numVisible="3" :numScroll="3" :responsiveOptions="responsiveOptions">
            <template #item="slotProps">
              <div class="m-2 bg-[#fff]">
                <div class="py-[45px] px-[25px] min-h-[400px]">
                  ...
                  <p class="m-0 text-[#20407C]">{{ slotProps.data.description }}</p>
                </div>
              </div>  
            </template>
          </Carousel> 
