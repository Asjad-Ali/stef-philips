<template>
    <div class>
        <div class="h-[40px] w-full bg-[#707070] bl flex justify-center ">
            <nav class="w-[70%]  mx-auto flex items-center justify-start gap-3 inner ">
                ...
                <i class="pi pi-angle-right text-white"></i>
                <div active-class="active" class="text-white font-bold-custom text-[14px]">Temporary Accommodation</div> 
            </nav>
        </div>
      ...
      <div class="w-[60%] h-[500px] mx-auto flex items-center">
        ...
        <div class="w-[409px] h-[45px] min-h-[60px] max-w-sm groupImg lg:ml-[4rem] lg:mt-[5rem]">
          <h1 class="font-light-custom text-[34px] leading-none text-white content">
            <span>Our <span class="font-black-custom text-[34px]">TA </span>/  </span><br>
            ...
            <div class="max-w-lg">
              <div class="">
                <h1 class="font-light-custom sm:text-[36px] text-[30px]  text-white leading-none">
                    The UK’s need for 
                  <span class="font-black-custom sm:text-[36px] text-[30px]">TA</span>
                </h1>
            ...
            <div class="mx-auto w-[70%] ">
                <div class="lg:py-36 xxxs:py-10">           
                    <div class="flex">
                        ...
                        <img src="../assets/communities-help-TA.png" alt />
                        </div>
  ...
  .bgImg {
    background-image: url("../assets/Overlay-tem-acc.png");
