  ...
  <div class="h-[40px] w-full bg-[#707070] bl flex justify-center ">
    <nav class="w-[60%]  mx-auto flex items-center justify-start gap-3 inner ">
      ...
      <i class="pi pi-angle-right text-white"></i>
        ...
        <i class="pi pi-angle-right text-white"></i>
        <router-link active-class="active" class="text-white font-semibold text-sm font-bold-custom" to="/news-article">News article</router-link>
    </nav>
  </div> 
        ...
        >Category</button>
          ...
          <div class="flex mt-3 space-x-4 md:order-2">
            <a
              ...
              :key="item.name"
              :href="item.href"
              class="text-[#20407C] hover:text-[#3461B6]"
            >
      ...
      <div class="flex items-center justify-center">
        <div class="w-4/5">
          ...
          <ul class="list-disc md:text-md text-[#1D1D33] my-3 leading-snug">
            ...
            <li>Duis eros ante, malesuada non risus vitae, dapibus sagittis neque. Mauris blandit ut justo nec molestie. Ut hendrerit erat nec maximus rutrum.</li>
          </ul>
        </div>
      </div>
    </div>
